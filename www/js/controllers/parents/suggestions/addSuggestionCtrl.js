(function () {
    ...
    angular.module('yugma')
        ...
        .controller('addSuggestionCtrl', function ($scope, $state, $ionicHistory, USER, suggestionService, customService) {
                ...
                var getTeacher = function (standardId) {
                    suggestionService.getTeacher(standardId).then(function (response) {
                ...
                function getAllCategory() {
                    suggestionService.getAllCategory().then(function (response) {
                ...
                $scope.suggestionSubmit = function (suggestion) {
                    ...
                    var finalData = {
                        ...
                        anonymous: suggestion.isChecked

                    }
                    
                    suggestionService.saveTeacherSuggestion(finalData).then(function (response) {
